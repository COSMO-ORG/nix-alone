...
snowpack_folder = (
    "/home/varun/WORKING/snowpack_vs_ssa/snowpack_from_trunk/sim_folder/sim_2/output_rerun/"
)
fname = snowpack_folder + "WFJ2_HS_RUN_forcing_PSUM_RUN_forcing.smet"
df_snowpack_forcing = read_data.read_smet_file(fname)
...
df_snowpack_forcing.to_csv(
    "./ssa_input.txt", float_format="%g", header=False, index=False
)
