...
!------------------------------------------------------------------------------
  ...
  REAL  (KIND=wp), PARAMETER           ::  &
    ...
    e_snow                      = 0.98_wp                , & ! > Long-wave emissivity for snow

    min_newsnow_layer           = 0.002_wp               , & ! > minimum new snow layer thickness, precipitation below this threshold
                                                             !   is kept in storage, until sufficient precipitation has accumulated to
                                                             !   build min_newsnow_layer (m)
